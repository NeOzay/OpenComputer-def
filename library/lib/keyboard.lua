...
--- Checks if either left or right Alt key is currently held down.
---@return boolean
...
--- Checks if either left or right Control key is currently held down.
---@return boolean
function keyboard.isControlDown() end

--- Checks if a specific key is currently held down.
---@param charOrCode string|number
---@return boolean
function keyboard.isKeyDown(charOrCode) end

--- Checks if either left or right Shift key is currently held down.
---@return boolean
